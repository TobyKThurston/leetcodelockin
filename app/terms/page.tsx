      ...
      <main className="max-w-3xl mx-auto px-6 sm:px-10 pt-32 pb-20">
        ...
        <section className="mt-10">
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px] text-slate-400">
            ...
            <li>Refunds are handled on a case-by-case basis. Contact us at <a href="mailto:hello@leetlockin.com" className="text-blue-400 hover:text-blue-300">hello@leetlockin.com</a> for refund requests.</li>
          </ul>
        </section>
